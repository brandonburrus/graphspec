/**
 * The graphspec commander program.
 *
 * Kept separate from the entry point so tests can build and inspect the program without
 * importing a module that parses argv and exits the process on import.
 */
